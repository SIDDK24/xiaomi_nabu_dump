...
cat vendor_bootimg/05_dtbdump_z$,|`T.dtb.* 2>/dev/null >> vendor_bootimg/05_dtbdump_z$,|`T.dtb
rm -f vendor_bootimg/05_dtbdump_z$,|`T.dtb.* 2>/dev/null
cat bootimg/01_dtbdump_gO"PW.dtb.* 2>/dev/null >> bootimg/01_dtbdump_gO"PW.dtb
rm -f bootimg/01_dtbdump_gO"PW.dtb.* 2>/dev/null
...
cat system/system/lib/liblhdc.so.* 2>/dev/null >> system/system/lib/liblhdc.so
rm -f system/system/lib/liblhdc.so.* 2>/dev/null
...
cat system/system/app/MIUINotesPad/MIUINotesPad.apk.* 2>/dev/null >> system/system/app/MIUINotesPad/MIUINotesPad.apk
rm -f system/system/app/MIUINotesPad/MIUINotesPad.apk.* 2>/dev/null
cat system/system/lib64/liblhdc.so.* 2>/dev/null >> system/system/lib64/liblhdc.so
rm -f system/system/lib64/liblhdc.so.* 2>/dev/null
...
cat system/system/priv-app/MiuiFreeformService/MiuiFreeformService.apk.* 2>/dev/null >> system/system/priv-app/MiuiFreeformService/MiuiFreeformService.apk
rm -f system/system/priv-app/MiuiFreeformService/MiuiFreeformService.apk.* 2>/dev/null
