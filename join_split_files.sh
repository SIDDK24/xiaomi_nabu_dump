...
cat vendor_bootimg/05_dtbdump_	qcom,rtic-id.dtb.* 2>/dev/null >> vendor_bootimg/05_dtbdump_	qcom,rtic-id.dtb
rm -f vendor_bootimg/05_dtbdump_	qcom,rtic-id.dtb.* 2>/dev/null
